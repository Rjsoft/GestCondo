...
- `docs/audit/ACCESSIBILITY_AUDIT.md` — acessibilidade a leitores de ecrã (NVDA), achados A1–A5. Requisito explícito do utilizador para toda a app, não só um módulo.
