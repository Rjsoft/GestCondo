...
| RGPD-03 | DPA em falta, cenário que o justifica já em produção (onboarding multi-condomínio) | Alta | **P1** | Art. 28º RGPD | Redigir/negociar DPA — ver `LEGAL_DOCUMENTS_REGISTER.md` (Fase F) | — |
