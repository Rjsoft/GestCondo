...
**P1**: G05 (quotas extraordinárias ligadas a deliberação), G09 (balanço patrimonial Ativo/Passivo — dependências G01/G02/G06 já satisfeitas em desenvolvimento).
...
G01, G02, G06, G07, G08 removidos destas listas — implementados e em produção (G01/G02 desde 2026-07-24, G06/G07/G08 desde 2026-07-25). Esta correção também resolve uma contradição interna pré-existente do documento: a matriz da secção 3 já marcava G01/G02 como ✅ em produção, mas continuavam listados aqui como lacunas P2.
