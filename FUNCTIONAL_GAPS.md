...
| Declarações de dívida | ❌ Em falta — **prioridade subida 2026-07-22** | Documento formal exigido em compra/venda de fração. Confirmado com base legal exata na auditoria jurídica (`docs/audit/LEGAL_COMPLIANCE_AUDIT.md`, achado LEGAL-01): art. 1424º-A CC (Lei n.º 8/2022) exige que o administrador emita, a pedido do condómino, declaração de encargos/dívidas no prazo máximo de 10 dias — documento instrutório obrigatório da escritura de venda. Dados já existem (`getMapaSaldos()`); falta só a página imprimível (mesmo padrão do recibo/balanço). | **P1** (subido de P2) |
