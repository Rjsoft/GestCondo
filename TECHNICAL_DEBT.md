...
- **Linguagem:** TypeScript 5.7, `strict: true` no `tsconfig.json`, mas `typescript.ignoreBuildErrors: true` no `next.config.mjs` anula esse rigor no build (ver `SECURITY_AUDIT.md` S15).
